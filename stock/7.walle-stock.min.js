(window.webpackJsonp=window.webpackJsonp||[]).push([[7],{295:function(t,e,n){"use strict";var i=n(9),a=n(40),r=[].reverse,o=[1,2];i({target:"Array",proto:!0,forced:String(o)===String(o.reverse())},{reverse:function(){return a(this)&&(this.length=this.length),r.call(this)}})},381:function(t,e,n){var i=n(61),a=n(382);"string"==typeof(a=a.__esModule?a.default:a)&&(a=[[t.i,a,""]]);var r={insert:"head",singleton:!1},o=i(a,r),s=a.locals?a.locals:{};a.locals||t.hot.accept(382,(function(){var e=n(382);"string"==typeof(e=e.__esModule?e.default:e)&&(e=[[t.i,e,""]]),o(e)})),t.hot.dispose((function(){o()})),t.exports=s},382:function(t,e,n){(e=n(62)(!1)).push([t.i,"\n.chart[data-v-2cab927c] {\n  width: 80%;\n  margin: auto;\n  margin-bottom: 30px;\n}\n.title[data-v-2cab927c] {\n  text-align: center;\n  font-size: 16px;\n  cursor: pointer;\n}\ncanvas[data-v-2cab927c]{\n  -moz-user-select: none;\n  -webkit-user-select: none;\n  -ms-user-select: none;\n}\n",""]),t.exports=e},418:function(t,e,n){"use strict";n.r(e),n.d(e,"render",(function(){return i})),n.d(e,"staticRenderFns",(function(){return a}));var i=function(){var t=this.$createElement,e=this._self._c||t;return e("div",{staticClass:"chart"},[this.chartTitle.titleTip?e("div",{staticClass:"title",attrs:{title:this.chartTitle.titleTip}},[e("a",[this._v(this._s(this.chartTitle.title))])]):this._e(),this._v(" "),e("canvas",{ref:"canvas"})])},a=[];i._withStripped=!0},419:function(t,e,n){"use strict";n(295);var i=n(649),a=n.n(i),r={props:["title","titleTip","labels","datasets","labelTitleX","labelTitleY"],data:function(){var t=this;return{chartsInstance:null,chartTitle:{title:this.$props.title||"Walle Stock Chart",titleTip:""},config:{type:"line",data:{labels:this.$props.labels?this.$props.labels.reverse():[],datasets:this.$props.datasets||[]},options:{responsive:!0,title:{display:!0},tooltips:{mode:"index",intersect:!1},hover:{mode:"nearest",intersect:!0},scales:{xAxes:[{display:!0,scaleLabel:{display:!0,labelString:this.labelTitleX||"DateTime"}}],yAxes:[{display:!0,scaleLabel:{display:!0,labelString:this.labelTitleY||"PTC Change"}}]},pan:{enabled:!0,mode:"xy"},zoom:{enabled:!0,mode:"xy"},onClick:function(e,n){try{if(!n.length)return;var i=n[0],a=t.config.data.labels[i._index],r=t.config.data.datasets[i._datasetIndex].data[i._datasetIndex];t.$emit("point-click",{x:a,y:r})}catch(t){console.warn("#Chart# click ",t)}}}}}},mounted:function(){var t=this.$refs.canvas.getContext("2d");a.a.defaults.global.defaultFontFamily='"Microsoft Yahei", monospace',a.a.defaults.global.defaultFontFamily="12px",this.chartsInstance=new a.a(t,this.config)},methods:{destory:function(){this.chartsInstance&&this.chartsInstance.destroy()},clear:function(){this.chartsInstance&&this.update({labels:[],datasets:[]})},update:function(t){var e=t.labels,n=t.datasets,i=t.title,a=void 0===i?"":i,r=t.titleTip,o=void 0===r?"":r;e&&n&&(this.config.data.labels=e.reverse(),this.config.data.datasets=n),this.chartTitle.title=o?a||"Walle Stock Chart":a,this.chartTitle.titleTip=o,this.chartsInstance&&this.chartsInstance.update(this.config)}}};e.a=r},649:function(t,e,n){
/*!
 * Chart.js v2.9.3
